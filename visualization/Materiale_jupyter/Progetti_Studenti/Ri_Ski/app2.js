...
d3.csv('dataset/athletes_sochi_lat.csv', 
    function(d) {
        d.impronunciability = 0
        return d
    }, 
    function(data){
    ...
    var gSilver = d3.select('svg')
        .append('g')
        .attr('class', 'silver')
        .attr('transform', 'translate(' + (maxRadius*7) +',0)')

    var gBronze = d3.select('svg')
        .append('g')
        .attr('class', 'bronze')
        .attr('transform', 'translate(' + (maxRadius*7)*2 +',0)')

    var gNone = d3.select('svg')
        .append('g')
        .attr('class', 'none')
        .attr('transform', 'translate(' + (maxRadius*3) +','+maxRadius*3+')')
    
    var gAL1 = d3.select('svg')
        .append('g')
        .attr('class', 'al1')
        .attr('transform', 'translate(' + (maxRadius*3)*3.5 +','+maxRadius*3+')')
